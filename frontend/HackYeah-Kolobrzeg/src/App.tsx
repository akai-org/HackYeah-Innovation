      ...
      <div className="ibe-footer__creative-commons margins_l_r">
        ...
        <div className="ibe-footer__logotypes">
          <a
            ...
            alt="Strona główna Ministerstwa Edukacji i Nauki"
          >
            <img
          ...
          <a
            ...
            target="_blank"
            title="Otworzy się w nowym oknie"
            alt="Strona główna GovTech Polska"
          >
            <img
              className="ibe-footer__logotypes-item"
              alt="GovTech Polska"
          ...
          <a
            ...
            target="_blank"
            title="Otworzy się w nowym oknie"
            alt="Strona główna Instytutu Badań Edukacyjnych"
          >
            <img
          ...
          <a
            ...
            target="_blank"
            title="Otworzy się w nowym oknie"
            alt="Strona główna Ośrodka Rozwoju Edukacji"
          >
            <img
              className="ibe-footer__logotypes-item"
          ...
          <a
            ...
            target="_blank"
            title="Otworzy się w nowym oknie"
            alt="Strona główna Laboratorii Przyszłości"
          >
            <img
              className="ibe-footer__logotypes-item"
